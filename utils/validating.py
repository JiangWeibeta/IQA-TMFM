...
def valid_one_epoch(backbone, discriminator, save_output, tb_logger, test_dataloader,
    ...
    with torch.no_grad():
        ...
        for data in tqdm(test_dataloader):
            ...
            pred_logits_list.append(pred_logits[0].item())
    ...
    data.to_csv('/data0/dataset/IQA/ans3.csv', index=False)
    return avg_loss / sum
